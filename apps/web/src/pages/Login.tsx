            ...
            >
                ...
                <Box component="form" onSubmit={handleSubmit}>
                    ...
                    <Button
                        ...
                        variant="primary"
                        fullWidth
                        disabled={loading || !!emailFieldError || !!passwordFieldError}
                        sx={{ mb: 3, padding: "16px", fontSize: "16px", fontWeight: 600, display: "flex", alignItems: "center", gap: 1 }}
                    >
                        {loading ? <CircularProgress size={20} sx={{ color: "inherit" }} /> : "Увійти"}
                    </Button>
                    ...
                    <Box sx={{ textAlign: "center" }}>
                        <Typography variant="body2" sx={{ color: "rgba(255, 255, 255, 0.7)" }}>
                            ...
                            <Link component={RouterLink} to="/signup" sx={{ color: ({ palette }) => palette.primary.main, textDecoration: "none", fontWeight: 600, "&:hover": { textDecoration: "underline" } }}>
                                Зареєструватися
                            </Link>
                        </Typography>
                    </Box>
